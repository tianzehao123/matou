			...
			<div class="content">
				<div class="container">
					<div class="row">
						...
						<div class="col-xs-9">
							<input id="type" readonly="readonly" type="text" placeholder="请选择类型" data-toggle="modal" data-target="#myModal" />
			...
			<div class="content">
				<div class="container">
					<div class="row">
						...
						<div class="col-xs-9">
							<input id="title" type="text" placeholder="如某某需要音响师一名" maxlength="9"/>
						</div>
					</div>
				</div>
				<div class="main"></div>
			...
			<div class="content">
				<div class="container">
					<div class="row">
						...
						<div class="col-xs-9">
							<input id="appDate" readonly="readonly" type="text" placeholder="2016-11-09"/>
							<b class="right"><i class="right-arrow1"></i><i class="right-arrow2"></i></b>
						</div>
					</div>
				</div>
			...
			<div class="content">
				<div class="container">
					<div class="row">
						...
						<div class="col-xs-9">
							<input id="sex" readonly="readonly" type="text" placeholder="不限" data-toggle="modal" data-target="#sexModal"/>
							<b class="right"><i class="right-arrow1"></i><i class="right-arrow2"></i></b>
						</div>
					</div>
				</div>
			...
			<div class="content">
				<div class="container">
					<div class="row">
						...
						<div class="col-xs-9">
							<input maxlength="11" id="tel" onKeyUp="this.value=this.value.replace(/[^\d]/g,'') " type="text" placeholder="请输入电话">
						</div>
					</div>
				</div>
				<div class="main"></div>
			...
			<div class="content">
				<div class="container">
					<div class="row">
						...
						<div class="col-xs-9">
							<input id="wechat" type="text" placeholder="请输入微信号"/>
						</div>
					</div>
				</div>
				<div class="main"></div>
			...
			<div class="content">
				<div class="container">
					<div class="row">
						...
						<div class="col-xs-9">
							<input id="email" type="text" placeholder="请输入Email"/>
						</div>
					</div>
				</div>
				<div class="main"></div>
					...
					<div class="footer-top">
						<div class="container">
							<div class="row">
								...
								<div class="col-xs-9">
									<textarea id="detail" placeholder="输入其他详细信息"></textarea>
								</div>
							</div>
						</div>
					</div>
